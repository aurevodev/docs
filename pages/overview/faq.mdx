...
## How to connect a domain to your server? (Dedicated IP Required!)

Login to your domain register click DNS and create a `A` record `@` then point it to your server's IP without port. Example IP: `127.1.0.0`

After creating please try to connect to your server using the domain. Eg- ( `mymcserver.com` )

## DDoS protection?
We'd offer protection from DDoS attacks for free!
