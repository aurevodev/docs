...
Our servers are usually created and configured within 10 minutes, and all
relevant information, including the server's IP address and control panel login
details, will be emailed to you once the order is completed. You should receive
this email shortly after placing your order.
